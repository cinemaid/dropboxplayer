	...
	<div class="container">
		...
		<form id="action-form" action="action.php" method="POST" accept-charset="utf-8">
			<div class="form-group">
				...
				<input type="text" name="link" class="form-control" placeholder="Ex: https://www.dropbox.com/s/lnzbg5kcanc0sfe/The.Boss.Baby.Trailer.MP4" onclick="this.select()" required>
			</div>
